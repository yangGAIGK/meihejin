...
public class PSORecordController {

    @Autowired
    private PSORecordService PSORecordsService;
    @DeleteMapping("/delete")
    public ResponseEntity<Map<String, Object>> batchDeletePSORecords(@RequestBody Map<String, List<Integer>> request) {
        ...
        try {
            ...
            boolean success = PSORecordsService.deleteRecordsByIds(ids);
            if (success) {
                result.put("code", 1);
