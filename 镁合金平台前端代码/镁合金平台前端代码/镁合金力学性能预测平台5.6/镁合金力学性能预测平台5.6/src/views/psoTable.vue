  ...
  <div class="container">
    ...
    <div class="table-wrapper" v-else>
      ...
      >
        ...
        <!-- 表格列 -->
        <el-table-column prop="maxNum" label="最大数量" min-width="200" align="center" />
        <el-table-column prop="topValue" label="顶值" min-width="200" align="center" />
        <el-table-column prop="lowValue" label="低值" min-width="200" align="center" />
        <el-table-column prop="swarmSize" label="种群大小" min-width="200" align="center" />
        <el-table-column prop="individualFactor" label="个体因子" min-width="200" align="center" />
        <el-table-column prop="groupFactor" label="群体因子" min-width="200" align="center" />
        <el-table-column prop="inertiaFactor" label="惯性因子" min-width="200" align="center" />
    ...
    async fetchHistoryData() {
      ...
      try {
        ...
        const response = await axios.post(
            'http://localhost:8080/PSOrecords', // 确保URL正确
            {
    ...
    async batchDelete() {
      try {
        ...
        if (confirmDelete) {
          const token = localStorage.getItem('Authorization');
          try {
            const response = await axios.delete('http://localhost:8080/PSOrecords/delete', {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            ...
            console.error('删除失败：', axiosError);
            this.$message.error(`删除失败： ${axiosError.message}`);
          }
        }
      } catch (error) {
